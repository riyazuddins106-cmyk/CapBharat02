  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16, paddingBottom: insets.bottom + 32 }}>
        ...
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border, borderRadius: colors.radius }]}>
          <MenuItem icon="document-text-outline" title="Privacy Policy" subtitle="How we collect and use your data" onPress={() => Linking.openURL('https://servenow.in/privacy')} colors={colors} />
          <View style={[styles.divider, { backgroundColor: colors.border }]} />
          <MenuItem icon="reader-outline" title="Terms & Conditions" subtitle="Rules for using ServeNow" onPress={() => Linking.openURL('https://servenow.in/terms')} colors={colors} />
        </View>
