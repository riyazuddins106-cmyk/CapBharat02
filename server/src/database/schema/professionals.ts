...
export const professionals = pgTable('professionals', {
  ...
  payoutUpiId: varchar('payout_upi_id', { length: 255 }),
  payoutContactId: varchar('payout_contact_id', { length: 128 }),
  payoutFundAccountId: varchar('payout_fund_account_id', { length: 128 }),
